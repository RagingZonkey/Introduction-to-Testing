...
|    Нажать на кнопку "Закрыть ... по рынку"| Отображение надписи об обработке ордера на сервере. Исчезновение кнопки "Закрыть ... по рынку". Появление кнопки с надписью "Ок" |
